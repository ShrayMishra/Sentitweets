...
# Information from first tweet from the first tweet:
...
# Deriving useful data and adding to the dataframe:
...
# Calculating mean of tweet lenghts:
...
# Plotting the medium in pie chart:
